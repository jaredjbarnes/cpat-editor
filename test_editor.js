...
import { Select } from "./node_modules/@tcn/ui-controls/dist/select/select.js";
...
function TestEditor({ presenter }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(VStack, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FlexBox, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TextEditor, { presenter: presenter.textEditor }) })
  ] });
}
export {
  TestEditor
