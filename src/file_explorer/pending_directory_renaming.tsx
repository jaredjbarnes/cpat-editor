...
export interface PendingDirectoryRenamingProps {
  presenter: DirectoryRenaming;
}

export function PendingDirectoryRenaming({ presenter }: PendingDirectoryRenamingProps) {
